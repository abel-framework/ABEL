...
class Beam():
    ...
    def save(self, runnable=None, beamName="beam", series=None):
        ...
        if series is None:
            ...
            # open a new file
            filename = self.filename(runnable, beamName)
