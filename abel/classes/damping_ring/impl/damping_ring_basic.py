...
class DampingRingBasic(DampingRing):
    ...
    def __init__(self, nom_energy=None, emit_nx_target=None, emit_ny_target=None, bunch_separation_in_ring=10e-9, num_bunches_in_train=None, rep_rate_trains=None, fill_factor=0.9, max_dipole_field=1, rel_energy_loss_per_turn=0.001, num_rings=1):
