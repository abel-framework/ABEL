...
class StageTransWakeInstability(Stage):
    ...
    def track(self, beam0, savedepth=0, runnable=None, verbose=False):
        ...
        with concurrent.futures.ThreadPoolExecutor() as executor:
            future1 = executor.submit(transverse_wake_instability, plasma_density, Ez, bubble_radius, main_num_profile, x_slices_start, xp_slices_start, energy_slices_start, stage_length, s_slices_start, xi_slices)
            future2 = executor.submit(transverse_wake_instability, plasma_density, Ez, bubble_radius, main_num_profile, y_slices_start, yp_slices_start, energy_slices_start, stage_length, s_slices_start, xi_slices)
