...
def transverse_wake_instability(plasma_density, E_z, bubble_radius, num_profile, initial_offsets, initial_angles, initial_energies, stage_length, s_slices, xi_slices):
