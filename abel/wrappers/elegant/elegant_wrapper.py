...
def elegant_run(filename, beam0, inputbeamfile, outputbeamfile, verbose=False, tmpfolder=None, runnable=None, save_beams=True):
    ...
    verbose : bool, default=``False``
        If ``False``, suppress ELEGANT console output.
    ...
    runnable : ``Runnable`` object, optional
        The Runnable object used for the run

    save_beams : bool, default=``True``
        Save beam evolution throughout lattice
    ...
    evolution : list of ABEL ``Beam`` objects
